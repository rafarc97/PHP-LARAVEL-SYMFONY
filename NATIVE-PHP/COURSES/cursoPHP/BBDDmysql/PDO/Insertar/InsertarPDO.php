...
<body>
    ...
    //Los marcadores nos facilitan el uso de arrays asociativos
        ...
        try{
            ...
            $sql="INSERT INTO ARTÍCULOS (NOMBREARTÍCULO,SECCIÓN,PRECIO,FECHA,PAÍSDEORIGEN) VALUES (:NOMBRE, :SECCION, :PRECIO, :FECHA, :PAIS)";

            $resultado = $base->prepare($sql); //devuelve obj PDO statment

            $resultado->execute(array(":NOMBRE"=>$nombre, ":SECCION"=>$seccion, ":PRECIO"=>$precio ,":FECHA"=>$fecha, ":PAIS"=>$pais));
